...
func (controller *Controller) InitController(c SpringWeb.WebContainer) {
	c.GET("/getA", controller.GetA)
	c.GET("/getB", controller.GetB)
}

func (controller *Controller) GetA(context *SpringWeb.SpringWebContext) interface{} {
	fmt.Println("GetA...")
	return "aaa"
}

func (controller *Controller) GetB(context *SpringWeb.SpringWebContext) interface{} {
	fmt.Println("GetB...")
	return "error"
}
